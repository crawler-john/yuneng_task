...
//	strcat(buff, fill_up_inverter->id); //?????????????????????????????
	strcat(buff, "04");
	transdv(buff, fill_up_inverter->dv);
	transfrequency(buff, fill_up_inverter->gf*10.0);
	transtemperature(buff, fill_up_inverter->it);
	strcat(buff, "1");
	transdi(buff, fill_up_inverter->di);
	transgridvolt(buff, fill_up_inverter->gv);
	transreactivepower(buff, fill_up_inverter->reactive_power);
	transactivepower(buff, fill_up_inverter->active_power);
	...
	strcat(buff, "2");
	transdi(buff, fill_up_inverter->dib);
	transgridvolt(buff, fill_up_inverter->gvb);
	transreactivepower(buff, fill_up_inverter->reactive_powerb);
	transactivepower(buff, fill_up_inverter->active_powerb);
	...
	strcat(buff, "3");
	transdi(buff, fill_up_inverter->dic);
	transgridvolt(buff, fill_up_inverter->gvc);
	transreactivepower(buff, fill_up_inverter->reactive_powerc);
	transactivepower(buff, fill_up_inverter->active_powerc);
	...
	strcat(buff, "4");
	transdi(buff, fill_up_inverter->did);
...
int resolve_fill_up_data_to_buffer_for_yc1000(char *inverter_data, char *inverterid)
{
	...
	transgridvolt(buff, fill_up_inverter->gv);
	transreactivepower(buff, (int)(100*fill_up_inverter->reactive_power));
	transactivepower(buff, (int)(100*fill_up_inverter->active_power));
	...
	transgridvolt(buff, fill_up_inverter->gvb);
	transreactivepower(buff, (int)(100*fill_up_inverter->reactive_powerb));
	transactivepower(buff, (int)(100*fill_up_inverter->active_powerb));
	...
	transgridvolt(buff, fill_up_inverter->gvc);
	transreactivepower(buff, (int)(100*fill_up_inverter->reactive_powerc));
	transactivepower(buff, (int)(100*fill_up_inverter->active_powerc));
...
int protocol_all_lost_data(char *receivetime, int all_time_linux)
{
	...
	{
		sprintf(lost_data_info.sendbuff_all, "APS150000000020001%s%010d%010d%010d%s%03d",
				ecu.id,
