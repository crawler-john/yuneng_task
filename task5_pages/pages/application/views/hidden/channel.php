<form class="form-horizontal">
  <div class="form-group">
    <label class="col-sm-5 control-label">ECU当前信道</label>
    <div class="col-sm-4">
...
action="<?php echo base_url('index.php/hidden/set_channel');?>" method="post">
  <div class="form-group">
    <label for="old_channel" class="col-sm-5 control-label">原信道</label>
    <div class="col-sm-4">
  ...
  <div class="form-group">
    <label for="new_channel" class="col-sm-5 control-label">新信道</label>
    <div class="col-sm-4">
  ...
  <table class="table table-condensed table-striped table-hover table-bordered">
    <thead>
      <tr>
        ...
        <th class="col-xs-4"><?php echo "逆变器ID"; ?></th>
        <th class="col-xs-4"><?php echo "短地址"; ?></th>
        <th class="col-xs-4"><?php echo "绑定"; ?></th>        
      </tr>
    </thead>
    <tbody>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-8">
      <div id="divload">说明:ECU将随逆变器更改到新信道,若不勾选逆变器,则仅ECU被更改到新信道.</div>
    </div>
  </div>
</form>
